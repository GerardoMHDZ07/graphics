  ...
  paint() {
    ...
    for (let m = 0; m < 4; m++){
      for (let n = 0; n < 4; n++){
        ...
        let xA = 1 + n*lado - sideHalf;  let yA = 1 + m*lado - sideHalf;
        let xB = 1 + n*lado + sideHalf;  let yB = 1 + m*lado - sideHalf;
        let xC = 1 + n*lado + sideHalf;  let yC = 1 + m*lado + sideHalf;
        let xD = 1 + n*lado - sideHalf;  let yD = 1 + m*lado + sideHalf;

        // Centrar la cuadricula en el canvas
        xA -= 2.5; xB -= 2.5; xC -= 2.5; xD -= 2.5;
        yA -= 2.5; yB -= 2.5; yC -= 2.5; yD -= 2.5;
        ...
        for (let i = 0; i < 20; i++){
          ...
          let xD1 = p*xD + q*xA;  let yD1 = p*yD + q*yA;
