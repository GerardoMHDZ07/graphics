...
export class CanvasLocal {
  ...
  drawSpiralingSquares(
    ...
    let xA = cx - halfSide; let yA = cy + halfSide; // Top-left
    let xB = cx + halfSide; let yB = cy + halfSide; // Top-right
    let xC = cx + halfSide; let yC = cy - halfSide; // Bottom-right
    let xD = cx - halfSide; let yD = cy - halfSide; // Bottom-left
